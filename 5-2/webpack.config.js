...
module.exports = (env) => {
  return {
    ...
    output: {
      ...
      publicPath: '/',
      filename: env.production ? 'static/js/[name].[contenthash:8].js' : 'static/js/[name].js',
      chunkFilename: env.production ? 'static/js/[name].[contenthash:8].js' : 'static/js/[name].js'
    },
